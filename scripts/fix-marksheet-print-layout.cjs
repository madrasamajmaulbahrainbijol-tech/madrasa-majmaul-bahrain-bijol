...
const replacement = String.raw`function printWindow(title:string,body:string){
...
console.log('Admin marksheet print layout fixed: A4 one-page, photo, logo, signatures and stamp space.');
