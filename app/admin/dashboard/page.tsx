...
export default function AdminDashboardPage() {
  ...
  if (loading) {
    return <main className="flex min-h-screen items-center justify-center bg-gray-50"><div className="text-center"><div className="mx-auto h-12 w-12 animate-spin rounded-full border-4 border-green-200 border-t-green-700" /><p className="mt-4 font-semibold text-gray-600">Loading admin panel...</p></div></main>;
  }
    ...
    <main className="min-h-screen bg-gray-50">
      <header className="border-b border-gray-200 bg-white shadow-sm">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3"><img src="/mmbb-logo.svg" alt="Madrasa Majmaul Bahrain Bijol official logo" className="h-14 w-14 rounded-full bg-white object-contain p-0.5 shadow-sm ring-1 ring-green-100" /><div><p className="text-sm font-semibold text-green-700">Madrasa Majmaul Bahrain Bijol</p><h1 className="mt-1 text-2xl font-bold text-gray-900">Admin Dashboard</h1></div></div>
