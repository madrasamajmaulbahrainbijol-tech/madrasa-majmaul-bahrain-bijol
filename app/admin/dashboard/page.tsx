      ...
      <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-4">
            <div className="rounded-xl bg-emerald-50 p-4"><p className="font-black text-emerald-800">Take Admission</p><p className="mt-1 text-sm text-emerald-900">Office staff can enter a guardian&apos;s form directly. It still follows the normal approval workflow.</p></div>
            <div className="rounded-xl bg-green-50 p-4"><p className="font-black text-green-800">Admissions</p><p className="mt-1 text-sm text-green-900">Only new applications appear here until an admin takes a decision.</p></div>
            <div className="rounded-xl bg-purple-50 p-4"><p className="font-black text-purple-800">Students</p><p className="mt-1 text-sm text-purple-900">Only approved + active accounts count as current students.</p></div>
            <div className="rounded-xl bg-lime-50 p-4"><p className="font-black text-lime-800">Donate Page</p><p className="mt-1 text-sm text-lime-900">The public donation page is controlled from the Donate Page card.</p></div>
          </div>
        </div>
      </section>
    </main>
